...
frontend_node_dependencies() {
  ...
  sudo su - ploi <<EOF
  cd /home/ploi/${instancia_add}/frontend
  npm install
EOF
...
frontend_update() {
  ...
  git pull
  cd /home/ploi/${empresa_atualizar}/frontend
  npm install
  rm -rf build
  npm run build
...
sudo su - ploi << EOF
  cat <<[-]EOF > /home/ploi/${instancia_add}/frontend/.env
...
sudo su - ploi << EOF
  cat <<[-]EOF > /home/ploi/${instancia_add}/frontend/server.js
